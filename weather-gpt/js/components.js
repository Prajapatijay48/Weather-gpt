...
// 2. Navbar Component
// --------------------------------------------------------------------------
const Navbar = ({ unit, setUnit, activeNav, setActiveNav }) => {
...
// --------------------------------------------------------------------------
const Hero = ({ currentCity, onCitySelect, unit, convertTemp }) => {
  ...
  const demoCities = window.WEATHER_CITIES || [];
        ...
        <div className="hero-content">
          ...
          <div className="chips-container">
            ...
            {demoCities.map((city) => (
              <button
                key={city.id}
                className={`city-chip ${currentCity.id === city.id ? "active" : ""}`}
                onClick={() => {
                  setSearchInput("");
...
// --------------------------------------------------------------------------
const WeatherMap = ({ currentCity, convertTemp }) => {
  ...
  }, [currentCity, convertTemp, isPlaying]);
  ...
  return (
    <div id="map" className="glass-card map-card">
      ...
      <div className="map-container-box">
        ...
        {/* Recenter button */}
        <button className="map-recenter-btn" onClick={handleRecenter} title="Recenter to Station">
        ...
        <div className="footer-content">
          <div className="footer-left">
            ...
            <p className="footer-copy">
              © 2026 Weather-GPT Intelligence. Built for Hackathon Presentation.
            </p>
          </div>

          <div className="footer-badges">
            <span className="hackathon-badge">React 18</span>
            <span className="hackathon-badge">Chart.js</span>
            <span className="hackathon-badge">Leaflet</span>
            <span className="hackathon-badge">GSAP</span>
            <span className="hackathon-badge">Zero-Backend</span>
          </div>
        </div>
      </div>
    </footer>
